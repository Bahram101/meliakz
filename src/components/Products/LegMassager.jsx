                ...
                <div className="navigation-wrapper">
                  <div ref={sliderRef} className="keen-slider">
                    <div className="keen-slider__slide number-slide1">
                      <img src={leg1} alt="массажер для ног" />
                    </div>
                    <div className="keen-slider__slide number-slide2">
                      <img src={leg3} alt="массажер для ног" />
                    </div>
                  </div>
          ...
          <Col md={6} className="feature">
            ...
            <table className="border-collapse" border-spacing="1" width="100%">
              <tbody>
                ...
                <tr>
                  <td>Вид:</td>
                  <td className="text-right">массажавибрационный</td>
                </tr>
                <tr>
                  <td>Зона массажа:</td>
                ...
                <tr>
                  <td>Цвет:</td>
                  <td className="text-right">черный, серый</td>
                </tr>
              </tbody>
            </table>
          </Col>
            ...
            <div className="">
              <div className="demoContacts">
                <a href="tel:+77076395949">
                  ...
                  <span style={{ marginLeft: "5px" }}>+7 (707) 639-59-49</span>
                </a>
              </div>
              <div>
